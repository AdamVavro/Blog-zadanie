...
export default function Custom404() {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100 dark:bg-background">
      <h1 className="text-4xl font-bold text-gray-800 dark:text-white mb-4">404 - Stránka nenájdená</h1>
      <p className="text-gray-600 dark:text-gray-400 mb-8">Prepáčte, ale stránka, ktorú hľadáte, neexistuje.</p>
